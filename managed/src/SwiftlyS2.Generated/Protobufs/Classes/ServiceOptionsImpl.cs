...
internal class ServiceOptionsImpl : TypedProtobuf<ServiceOptions>, ServiceOptions
{
  public ServiceOptionsImpl(nint handle, bool isManuallyAllocated): base(handle)
  {
  }
