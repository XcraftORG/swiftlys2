...
internal class ExtensionRangeOptionsImpl : TypedProtobuf<ExtensionRangeOptions>, ExtensionRangeOptions
{
  public ExtensionRangeOptionsImpl(nint handle, bool isManuallyAllocated): base(handle)
  {
  }
